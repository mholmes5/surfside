...
<head>
    <meta charset="UTF-8">
    <title>Surfside Resort Reservation Confirmation</title>
...
<body>
    ...
    <main id="content" role="main">
        ...
        <?php
            $fname = $lname = $email = $phone = $location = $unit = "";
            $address= $city= $state = $zip = $adults = $kids = "" ;
            ...
            echo"Thank you {$fname} {$lname}, your reservation has been completed. We look forward to you joining us at Surfside. Please contact us if you have any questions or concerns. Your reservation details are below."."<br>";
    ...
    ?>
    <a href="../makeReservation.html" title="Make A reservation">Go Back</a>
    </main>
